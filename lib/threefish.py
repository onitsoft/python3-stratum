...
u"""Pure Python implementation of the Threefish block cipher
...
class Threefish512(object):
    u"""The Threefish 512-bit block cipher.
    ...
    def encrypt_block(self, plaintext):
        u"""Return 8-word ciphertext, encrypted from plaintext.
    ...
    def _feed_forward(self, state, plaintext):
        u"""Compute additional step required when hashing.
    ...
    def decrypt_block(self, ciphertext):
        u"""Return 8-word plaintext, decrypted from plaintext.
